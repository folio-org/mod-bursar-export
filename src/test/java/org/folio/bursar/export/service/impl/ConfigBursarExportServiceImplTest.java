...
import org.folio.bursar.export.config.AppConfig;
import org.folio.bursar.export.domain.dto.BursarExportConfig;
import org.folio.bursar.export.domain.dto.BursarExportConfig.SchedulePeriodEnum;
import org.folio.bursar.export.domain.dto.BursarExportConfig.WeekDaysEnum;
...
@SpringBootTest(classes = {ConfigBursarExportServiceImpl.class, AppConfig.class})
class ConfigBursarExportServiceImplTest {
  ...
  @Autowired
  private ConfigBursarExportService service;
  @Autowired
  ...
  void addConfig() throws JsonProcessingException {
    BursarExportConfig bursarExportConfig = new BursarExportConfig();
    bursarExportConfig.setDaysOutstanding(9);
    bursarExportConfig.setPatronGroups(List.of(UUID.randomUUID().toString()));
  ...
  private ConfigModel mockResponse(BursarExportConfig bursarExportConfig)
  ...
  void getConfig() {
    ...
    final BursarExportConfig exportConfig = config.get();
